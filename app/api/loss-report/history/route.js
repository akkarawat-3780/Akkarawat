...
export async function GET() {
  try {
    ...
    const [rows] = await db.execute(
      `SELECT lr.LossReport_ID, lr.LossReport_Date, lr.LossReport_receipt, lr.LossReport_Status, lr.admin_email, br.Borrow_ID, br.Bicycle_ID 
      ...
      WHERE lr.nisit_email = ? ORDER BY lr.LossReport_Date DESC`,
      [nisit_email]
    );
